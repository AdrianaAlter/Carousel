	...
	var Wrapper = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement('section', { className: "sample " + this.state.background })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = React.createClass({
	  ...
	  render: function () {
	    return React.createElement('li', { onClick: this.props.handleClick, className: this.props.status + " " + this.props.content });
	  }
